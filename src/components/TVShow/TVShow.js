  ...
  return (
    <div className="tv-show-container">
      <div className="jumbotron-container">
        <div 
          className="jumbotron" 
          style={{backgroundImage: "url(https://image.tmdb.org/t/p/original" + tvShowData.backdrop_path + ")"}}>
                ...
                <span className="tv-show-episodes__total">
                  {tvShowData.number_of_episodes &&
                    <Fragment>
                      ...
                      <span className="episode-length">({tvShowData.episode_run_time[0]} min each)</span>
                    </Fragment>
                  }
                </span>
              </h3>
